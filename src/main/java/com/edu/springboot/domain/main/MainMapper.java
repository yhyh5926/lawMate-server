...
import com.edu.springboot.domain.main.vo.*; // MainQuestionVO를 포함한 모든 VO 임포트
...
public interface MainMapper {
	...
	/** 최근 판례 5개 */
	List<MainPrecedentVO> selectRecentPrecedents();

	/** 최근 등록 변호사 5개 */
	List<MainLawyerVO> selectRecentLawyers();

	/** 최근 등록 설문 5개 */
	List<MainPollVO> selectRecentPolls();

	/** 최근 법률 질문 5개 (QuestionMapper 로직 기반) */
	...
	/**
	 * 차트용: 최근 N일(오늘 포함) 일자별 사건 수 - Oracle ORA-00923 방지 위해 SQL에서 (? - 1) 연산 제거 -
